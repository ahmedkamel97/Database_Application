...
from sqlalchemy import create_engine, Column, Text, Integer, ForeignKey, DateTime, VARCHAR
from sqlalchemy.ext.declarative import declarative_base
from sqlalchemy.orm import relationship

#Creating the database file and intitating the engine.
...
#The first table to store the information of the house sellers  
class Sellers(Base):
...
class Listings(Base):
    ...
    def __repr__(self):
        return "<Listing (ListingID={0}, Bedroom={1}, Bathroom={2})>".format(self.ListingID, self.Bedroom,
                                                                             self.Bathroom)
...
class Transactions(Base):
    ...
    def __repr__(self):
        return "<Transaction(ID={0}, BuyerID={1}, SellerID={2})>".format(self.TransactionID, self.BuyerID,
                                                                         self.SellerID)
